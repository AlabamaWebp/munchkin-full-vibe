...
const ENGLISH = {
  ...
  sexRequiredBeforeStart: 'Every player must choose a character sex before the game can start.',
...
const RUSSIAN: Record<TranslationKey, string> = {
  ...
  sexRequiredBeforeStart: 'Перед началом игры каждый игрок должен выбрать пол персонажа.',
...
const NEW_RUSSIAN_NAMES: Readonly<Record<string, string>> = {
  ...
  'barrow-tax-collector': 'Сборщик пошлин с курганов',
  'granite-troll': 'Гранитный тролль',
  'sunken-court-wyrm': 'Змей затонувшего двора',
  'curse-oath-tangle': 'Проклятие! Узел клятв',
  'curse-mudbound-boots': 'Боевое проклятие! Сапоги в грязи',
  'oathbound-vanguard': 'Авангард клятвы',
  'hedge-conclave': 'Садовый конклав',
  riverkin: 'Речники',
  stonefolk: 'Каменники',
  'amberwood-bow': 'Лук янтарного дерева',
  'lantern-scale-coat': 'Панцирь фонарной чешуи',
  'cairn-cleaver': 'Курганный тесак',
  'banner-of-daring': 'Знамя отваги',
  'sorcerers-gale': 'Шквал чародеев',
  'rally-the-giant': 'Подзадорить великана',
  'old-road-cache': 'Тайник у старой дороги',
  'choir-looting-gargoyle': 'Гаргулья-хористка',
  'bell-tower-wraith': 'Призрак колокольни',
  'organ-grinder-hydra': 'Гидра шарманщика',
  'curse-cracked-hymnal': 'Проклятие! Треснувший гимнальник',
  'hearth-cantors': 'Певцы очага',
  'candle-scribes': 'Писцы свечей',
  'tinker-gnomes': 'Гномы-мастеровые',
  'moss-gnomes': 'Моховые гномы',
  chimeblade: 'Клинок-колоколец',
  'pocket-vestry': 'Карманная ризница',
  'resonance-satchel': 'Сумка резонанса',
  'resonant-rivet': 'Звучная заклёпка',
  'saints-polish': 'Полировка святых',
  'encore-of-courage': 'Бис храбрости',
  'misfiled-prophecy': 'Ошибочно подшитое пророчество',
  'backstage-passage': 'Закулисный проход',
  'quiet-acquisition-office': 'Тихое бюро приобретений',
  'wrong-pocket-courier': 'Курьер чужого кармана',
  'bridle-chewing-ogre': 'Огр, жующий уздечки',
  'stable-ghost': 'Конюшенный призрак',
  'thunderhoof-giant': 'Громокопытный великан',
  'curse-loose-stirrup': 'Боевое проклятие! Свободное стремя',
  'mule-cartographer': 'Мул-картограф',
  'reed-runner': 'Тростниковый бегун',
  'saddle-sage': 'Мудрец седла',
  'brass-stablehand': 'Латунный конюх',
  'iron-mane-ram': 'Баран с железной гривой',
  'dawn-courier': 'Рассветный курьер',
  'skybridge-elk': 'Лось небесного моста',
  'trailward-saddlebag': 'Дорожная седельная сумка',
  'mounted-charge': 'Конная атака',
  'spook-the-herd': 'Спугнуть табун',
  'waystation-gossip': 'Сплетни на станции',
  'crossed-door-signals': 'Перепутанные дверные сигналы',
  'stacked-hat-rail': 'Рейка для шляп в стопку',
  'foldout-grip-harness': 'Разворачивающаяся хватная упряжь',
  'roster-clerk': 'Картотечный смотритель',
  'caravan-wrangler': 'Погонщик каравана',
  'field-commendation': 'Полевая грамота',
  'unwelcome-ovation': 'Незваные овации',
};
